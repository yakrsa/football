...
FCAPP.REVIEW = FCAPP.REVIEW || {
    ...
    loadReviewList: function() {
        ...
        $.ajax({
            url: '/index.php?g=Wap&m=Index&a=impressdata&iVanvicms=mp.weixin.qq.com&token='+token,
            dataType: 'jsonp'
        });
    },
    ...
    loadProList: function() {
        ...
        $.ajax({
             url: '/index.php?g=Wap&m=Index&a=reviewdata&iVanvicms=mp.weixin.qq.com&token='+token,
            dataType: "jsonp",
