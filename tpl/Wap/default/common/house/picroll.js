...
FCAPP.HOUSE.Picroll = {
    ...
    init: function() {
        ...
        Picroll.loadData();
        var id = '';
        window.shareData.linkKeep = '/index.php?g=Wap&m=Index&a=hxdata&iVanvicms=mp.weixin.qq.com&token='+token;
    ...
    loadData: function() {
        ...
        $.ajax({
            ...
            url: '/index.php?g=Wap&m=Index&a=hxdata&iVanvicms=mp.weixin.qq.com&token='+token,
            dataType: 'jsonp',
            error: function() {
