...
class iVanvicms_Page {
     ...
     */
    function iVanvicms_Page($each_disNums, $nums, $current_page, $sub_pages, $subPage_link) {
    ...
    function __construct($each_disNums, $nums, $current_page, $sub_pages, $subPage_link) {
        ...
        $this->iVanvicms_Page($each_disNums, $nums, $current_page, $sub_pages, $subPage_link);
    }
    /*
